...
if (Cookies.get('common') == undefined) {
  ...
  commonToggle = Boolean(Cookies.get('common'))
  if (commonToggle) {
...
if (Cookies.get('uncommon') == undefined) {
  ...
  uncommonToggle = Boolean(Cookies.get('uncommon'))
  if (uncommonToggle) {
...
if (Cookies.get('rare') == undefined) {
  ...
  rareToggle = Boolean(Cookies.get('rare'))
  if (rareToggle) {
    $('#rareToggle').bootstrapToggle('on')
  }
  else {
...
if (Cookies.get('veryrare') == undefined) {
  ...
  veryRareToggle = Boolean(Cookies.get('veryrare'))
  if (veryRareToggle) {
    $('#veryRareToggle').bootstrapToggle('on')
  }
  else {
...
if (Cookies.get('ultrare') == undefined) {
  ...
  ultraRareToggle = Boolean(Cookies.get('ultrarare'))
  if (ultraRareToggle) {
    $('#ultraRareToggle').bootstrapToggle('on')
  }
  else {
...
$('#ultraRareToggle').change(function() {
  ...
  Cookies.set('ultrarare', ultraRareToggle)

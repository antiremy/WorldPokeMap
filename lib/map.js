...
window.onload = function () {
  ...
  window.setInterval(getCaptchaStats("getbalance"),60000)
...
map.setView([59.3892144, -100.4054629], 5);
...
// var redDeerMarker = L.marker([52.271446, -113.804089],{icon: defaultIcon})
// redDeerPopup = L.popup().setContent('<center><strong>Subscribe to Unlock Red Deer</strong>' +
// '<br>More Info</center>'
// )
// redDeerMarker.bindPopup(redDeerPopup)
// redDeerMarker.on('mouseover', function(e) {
//   redDeerMarker.openPopup()
// })
// redDeerMarker.on('mouseout', function(e) {
//   if (mouseOut) {
//     redDeerMarker.closePopup()
//   }
// })
// redDeerMarker.on('click', function (e) {
//     redDeerMarker.openPopup()
//     mouseOut = false
// });
// redDeerMarker.on('popupclose', function (e) {
//     if (!mouseOut) {
//         mouseOut = true
//     }
// })
...
//   noClip: true
// })
// cityMarkers.addLayer(redDeerMarker)
...
function defaultInterval() {
    ...
    updateInterval = window.setInterval(update, 5500)
...
map.on('dragstart zoomstart movestart zoomlevelschange', function (e) {
    clearIntervals()
    clearTimeouts()
});
...
function makePokemon(pokemon) {
    ...
    pokemon.forEach(function (poke, index) {
        ...
        if (notifPokemon.includes(pokeID) && !notifiedPokemon.includes(encID)) {
